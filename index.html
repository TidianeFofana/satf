                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <select name="subject" id="subject">
                                                ...
                                                <option value="subject1">Website Design</option>
                                                <option value="subject3">Photography</option>
                                                <option value="subject2">Development</option>
                                                <option value="subject3">SEO/Marketing</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
